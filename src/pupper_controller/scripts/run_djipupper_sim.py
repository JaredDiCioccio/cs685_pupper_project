...
realSenseThread = None
realSenseStopEvent = None

def runRealsense(stopEvent):
...
def main(FLAGS):
    print(FLAGS)
    """Main program"""
    if FLAGS.withRealsense:
        realSenseStopEvent = Event()
        realSenseThread = Thread(target=runRealsense, args=(realSenseStopEvent,))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--withRealsense", help="launch realsense camera", action="store_true")
